...
<template>
  <div class="editor-wrapper">
    ...
    <div class="editor-content" :class="{ disabled: props.disabled }">
      <EditorContent
        v-if="isReady"
        :editor="editor"
    ...
    <div class="editor-actions">
      <button type="button" class="action-btn ghost" :disabled="props.disabled" @click="emit('cancel')">
        Cancel
      </button>
      <button type="button" class="action-btn primary" :disabled="props.disabled" @click="submit">
        Post
      </button>
    </div>
  </div>
